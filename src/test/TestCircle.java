...
public class TestCircle {
    ...
    public void testMoveCircle() {
        ...
        circle.moveTo(new Point(1000, 2000));
        assertAll(
                () -> assertEquals(1000, circle.getCenter().getX()),
                () -> assertEquals(2000, circle.getCenter().getY()),
                () -> assertEquals(10, circle.getRadius())
        );
    }
    ...
    @Test
    public void testSetCenterAndRadiusCircle() {
        Circle circle = new Circle(10, 20, 10);
